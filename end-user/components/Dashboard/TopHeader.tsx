...
import { SearchIcon, BellBadgeIcon, ChevronDownIcon } from"./DashboardIcons";
...
export function TopHeader({
 ...
 return (
 <header className="bg-white border-b border-slate-200 px-4 md:px-8 lg:px-12 py-3 flex items-center justify-between sticky top-0 z-30">
 {/* Left: Logo */}
  ...
  <span className="text-indigo-900 font-extrabold tracking-wider text-lg md:text-xl uppercase">CMS</span>
  </div>
 ...
 >
 <BellBadgeIcon size={20} color="#64748b" hasBadge={true} />
 </button>
