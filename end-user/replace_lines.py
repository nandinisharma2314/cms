...
new_content = """        {currentStep === "welcome" && (
          <div className="relative flex flex-col items-center w-full h-full min-h-screen bg-white font-sans overflow-x-hidden pb-4">
            ...
            <div className="w-full max-w-[340px] mt-4 flex justify-center z-10 relative">
              <img src="/images/hero_worker_1790310873345.jpg" alt="City worker illustration" className="w-full h-auto object-contain" />
            </div>
...
# Reconstruct file
# 0-indexed array, so lines 446 to 565 corresponds to index 445 to 564
out_lines = lines[:445] + [new_content] + lines[565:]
