...
async function main() {
  ...
  try {
    ...
    fs.writeFileSync('/home/nandini/cms/end-user/scratch/step3_screenshot.png', Buffer.from(screenshot.data, 'base64'));
    console.log('Saved screenshot to /home/nandini/cms/end-user/scratch/step3_screenshot.png');
